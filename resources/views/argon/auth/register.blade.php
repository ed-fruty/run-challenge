                            ...
                            <form method="POST" action="{{ route('register') }}" role="form">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control" id="name" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Имя" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control" id="surname" name="surname" value="{{ old('surname') }}" autocomplete="surname" placeholder="Фамилия" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control" id="country" name="country" value="{{ old('country') }}" autocomplete="country" placeholder="Страна" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control" id="city" name="city" value="{{ old('city') }}" autocomplete="city" placeholder="Город" type="text">
                                    </div>
                                </div>
                                <div class="text-center">
